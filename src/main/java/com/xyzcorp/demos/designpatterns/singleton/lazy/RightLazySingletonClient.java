...
public class RightLazySingletonClient {
    ...
    public static void main(String[] args) throws InterruptedException {
      ...
      assert runner3.getInstance() == runner1.getInstance();
        ...
        assert runner1.getInstance().equals(runner2.getInstance());
        assert runner2.getInstance().equals(runner3.getInstance());
        assert runner3.getInstance().equals(runner4.getInstance());
        assert runner4.getInstance().equals(runner1.getInstance());
        assert runner2.getInstance().equals(runner4.getInstance());
        assert runner3.getInstance().equals(runner1.getInstance());
    }
}
