...
public class DatesTest {
    ...
    public void testChronoUnit() throws Exception {
        long between = ChronoUnit.DAYS.between
                (LocalDate.of(2017, 1, 1), LocalDate.now());
    ...
    public void testCustomizedFormat() {
        DateTimeFormatter obscurePattern =
                DateTimeFormatter.ofPattern("MMMM dd, yyyy '(In Time Zone: 'VV')' q 'Quarter'");
    ...
    public void testShiftingTimeZones() {
        ...
        System.out.println(tokyoTime.withZoneSameLocal(ZoneId.of("America/Los_Angeles")));
        System.out.println(tokyoTime.withZoneSameInstant(ZoneId.of("America/Los_Angeles")));
    }
